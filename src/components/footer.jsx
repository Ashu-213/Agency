    ...
    return (
        <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40 '>
            ...
            <div className='sapce-y-5 tt-sm text-gray-700 dark:text-gray-400'>
                <div className='flex justify-between w-full max-lg:flex-col gap-10 pb-10'>
                    {/* Left Side */}
                    ...
                    <div className='text-gray-600 dark:text-gray-400'>
                        ...
                        <div className='flex gap-2 text-sm'>
                            ...
                            <button className='px-6 bg-primary text-white rounded-full'>Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* footer bottom */}
            <div className='pb-6 text-sm text-gray-500 flex justify-between sm:justify-between gap-4 flex-wrap'>
